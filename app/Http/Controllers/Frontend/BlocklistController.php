...
class BlocklistController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.blocklists.index', compact('blocklists'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.blocklists.create', compact('questions', 'answers'));
    }
    ...
    public function store(StoreBlocklistRequest $request)
    {
        ...
        return redirect()->route('frontend.blocklists.index');
    }
    ...
    public function edit(Blocklist $blocklist)
    {
        ...
        return view('frontend.blocklists.edit', compact('questions', 'answers', 'blocklist'));
    }
    ...
    public function show(Blocklist $blocklist)
    {
        ...
        return view('frontend.blocklists.show', compact('blocklist'));
    }
