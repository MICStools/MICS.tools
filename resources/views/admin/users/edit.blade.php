                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('pic') ? 'has-error' : '' }}">
                            <label for="pic">{{ trans('cruds.user.fields.pic') }}</label>
                            <div class="needsclick dropzone" id="pic-dropzone">
                            </div>
                            @if($errors->has('pic'))
                                <span class="help-block" role="alert">{{ $errors->first('pic') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.user.fields.pic_helper') }}</span>
                        </div>
...
<script>
    ...
    init: function () {
@if(isset($user) && $user->pic)
      var file = {!! json_encode($user->pic) !!}
