                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('cost') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="cost" id="cost" value="{{ old('cost', '0') }}" step="0.01">
                            @if($errors->has('cost'))
                        ...
                        <div class="form-group {{ $errors->has('funding') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="funding" id="funding" value="{{ old('funding', '0') }}" step="0.01">
