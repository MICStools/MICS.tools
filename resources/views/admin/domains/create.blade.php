                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.domains.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('primarycolour') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="primarycolour" id="primarycolour" value="{{ old('primarycolour', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('secondarycolour') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="secondarycolour" id="secondarycolour" value="{{ old('secondarycolour', '') }}" required>
